...
def main():
    logo_path = os.environ.get("PARAYU_LOGO_PATH") or "build/icon.png"
    if not os.path.exists(logo_path):
        logo_path = "/Users/workmode/Desktop/Final Logo.png"
    if not os.path.exists(logo_path):
        logo_path = "build/logo_transparent.png"
        
    if not os.path.exists(logo_path):
        print(f"Error: Logo file not found. Set PARAYU_LOGO_PATH or place it at build/icon.png")
        sys.exit(1)
